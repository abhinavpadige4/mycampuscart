-- Insert sample products with valid categories
...
('Mini Refrigerator', 'Compact mini fridge perfect for dorm rooms. Energy efficient and in excellent condition.', 6500, 'furniture', 'Mumbai, Maharashtra', 'active', '8639081837', '{"https://images.unsplash.com/photo-1571175443880-49e1d25b2bc5?w=500"}', (SELECT id FROM user_profiles WHERE email = 'abhinavpadige06@gmail.com' LIMIT 1)),
...
('Hostel Essentials Kit', 'Complete hostel essentials including bedsheets, pillow covers, towels, and basic toiletries.', 2800, 'other', 'Mumbai, Maharashtra', 'active', '8639081837', '{"https://images.unsplash.com/photo-1555041469-a586c61ea9bc?w=500"}', (SELECT id FROM user_profiles WHERE email = 'abhinavpadige06@gmail.com' LIMIT 1)),
